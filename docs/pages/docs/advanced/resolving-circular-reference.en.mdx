...
<Callout type="info" emoji="💡">
  You can easily resolve the `useFlow()` circular reference issue by using the [Future API](/future-api/introduction). We recommend using the [Future API](/future-api/introduction).
</Callout>
