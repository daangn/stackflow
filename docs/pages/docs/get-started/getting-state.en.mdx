...
import { useStack, useFlow, type ActivityComponentType } from "@stackflow/react";
...
If you defined a `loader` for an activity in your config, you can access its data using the `useLoaderData()` hook.
