...
{/* |               |                                                |                                                      |
| ----------------- | -------------------------------------------------- | -------------------------------------------------------- |
| `id`              | Unique ID value for each activated activity screen | String                                                   |
| `name`            | Registerd activity name                             | String                                                   |
| `transitionState` | Transition state of current activity                          | `enter-active`, `enter-done`, `exit-active`, `exit-done` | */}
|                    |          |                                     |
| ------------------ | -------- | ----------------------------------- |
