...
import { listenOnce } from "../../common/utils";
import { createStyleEffect } from "./createStyleEffect";
import { OFFSET_PX_CUPERTINO } from "./createStyleEffectOffset";
            ...
            return new Promise((resolve) => {
              requestAnimationFrame(() => {
                ...
                refs.forEach((ref) => {
                  ...
                  $el.style.transition = globalVars.transitionDuration;
                  $el.style.transform = `translate3d(${
