...
import type { RequestHistoryTick } from "./makeHistoryTaskQueue";
...
export const makeHistorySyncPlugin =
  ...
  >(
    options: HistorySyncPluginOptions<T, K>,
  ): P => {
    ...
    const plugin: StackflowPlugin = () => {
      ...
      return {
        ...
        ...getOverrides({ activityRoutes, requestHistoryTick }),
      };
    };
